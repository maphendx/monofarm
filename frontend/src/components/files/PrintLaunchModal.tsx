...
export function PrintLaunchModal({
  ...
  const [selectedPrinterId, setSelectedPrinterId] = useState<number | null>(defaultPrinterId ?? null);
  ...
  function pickPrinter(p: Printer) {
                  ...
                  <div key={groupName}>
                    ...
                    <div className="grid grid-cols-1 gap-2 sm:grid-cols-2 lg:grid-cols-3">
                      {groupPrinters.map((p) => {
                        ...
                        return (
                          <button
                            key={p.id} onClick={() => pickPrinter(p)}
                            className={[
