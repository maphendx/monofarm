...
export function ImpersonationBanner() {
  ...
  return (
    <>
      <div className="fixed inset-x-0 top-0 z-[80] border-b border-[var(--state-warn)]/30 bg-[var(--state-warn)] text-black shadow-sm">
        <div className="mx-auto flex min-h-10 max-w-7xl items-center justify-between gap-3 px-4 py-2 text-sm">
          ...
          <button
            ...
            className="inline-flex h-7 shrink-0 items-center gap-1.5 rounded-sm border border-black/20 bg-black/10 px-2.5 text-xs font-semibold hover:bg-black/15"
          >
